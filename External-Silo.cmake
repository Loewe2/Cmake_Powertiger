...
ExternalProject_Add(
    Silo
        ...
        CONFIGURE_COMMAND  ./configure --prefix=${CMAKE_CURRENT_BINARY_DIR}/build/silo --with-hdf5=${CMAKE_CURRENT_BINARY_DIR}/build/hdf5/include,${CMAKE_CURRENT_BINARY_DIR}/build/hdf5/lib --enable-optimization
        BUILD_IN_SOURCE 1
